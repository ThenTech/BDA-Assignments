def is_palindrome_sentence(sentence):
    ...
    while countForward < countBackward:
        a = sentence[countForward].lower()
        b = sentence[countBackward].lower()
        ...
        elif not(sentence[countForward].lower() in alphabet) and not(sentence[countBackward].lower() in alphabet):
            countForward += 1
            countBackward -= 1
        else:
