...
def does_intersect(x1, y1, w1, h1, x2, y2, w2, h2):
    ...
    return do_line_fragments_on_same_line_intersect(rect1_x_axis_projection_point1, rect1_x_axis_projection_point2,
        rect1_y_axis_projection_point1, rect1_y_axis_projection_point2)  and do_line_fragments_on_same_line_intersect(rect2_x_axis_projection_point1, rect2_x_axis_projection_point2, rect2_y_axis_projection_point1, rect2_y_axis_projection_point2)