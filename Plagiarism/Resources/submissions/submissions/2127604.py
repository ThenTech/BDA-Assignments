...
#giving up for now if i use python tutor on a different site it returns the correct response, will check back when dodona is stable again
...
print("You have " + outputText + " euro!")
