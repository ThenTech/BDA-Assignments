woord11 = input("Geef een string: ")
woord22 = input("Geef een string: ")
...
for bla in woord11:
    if bla != " ":
        woord1 = woord1 + bla
for blabla in woord22:
    if blabla != " ":
        woord2 = woord2 + blabla
for letter in lijst:
    teller2 = 0
    teller3 = 0
...
for idfk in anagram:
    ...
    for echtniksmeer in woord2:
        if idfk == echtniksmeer:
            teller6 += 1
if teller5 == teller6 == len(woord1) == len(woord2):
    print(woord11, "and", woord22, "are anagrams")
else:
    print(woord11, "and", woord22, "are not anagrams")