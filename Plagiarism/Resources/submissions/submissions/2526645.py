def quick_sort(l, sorted_list=None, length_history=None):
    ...
    if len(sorted_list) != 0 and length_history[0] == len(sorted_list):
        return sorted_list
    ...
    if length_history[0] != len(sorted_list) and l1 is not None and len(l1) != 0:
    ...
    if length_history[0] != len(sorted_list) and l3 is not None and len(l3) != 0:
