...
money = float(input("How much money do you have to pay in eurocents? "))
euros_2 = money // 200
...
euros_5c = (money - euros_2*200 - euros_1*100 - euros_50c*50 - euros_20c*2 - euros_10c*10) // 5
euros_2c = (money - euros_2*200 - euros_1*100 - euros_50c*50 - euros_20c*2 - euros_10c*10 - euros_5c*5) // 2
