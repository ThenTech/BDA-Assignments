def merge_lists(list1, list2):
    ...
    while l1_counter < len(list1) and l2_counter < len(list2):
        if list1[l1_counter] < list2[l2_counter]:
            mergedlist.append(list1[l1_counter])
            l1_counter += 1
        else:
            mergedlist.append(list2[l2_counter])
            l2_counter += 1
    
    if l2_counter < len(list2):        
        for item in list2[l2_counter:]:
            mergedlist.append(item)
    if l1_counter < len(list1):        
